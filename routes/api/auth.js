...
router.post('/forgot', async (req, res) => {
	...
	try {
		...
		jwt.sign(payload, jwtSecret, { expiresIn: 360000 }, (err, token) => {
          ...
          <a href="https://electronicsolutioncenter.herokuapp.com/auth/${token}">reset password</>
        `;
...
router.post('/admin/forgot', async (req, res) => {
	...
	try {
		...
		jwt.sign(payload, jwtSecret, { expiresIn: 360000 }, (err, token) => {
          ...
          <h2>Password reset</h2>
          <p>Please click the link below to reset your password<p/>
          <a href="https://electronicsolutioncenter.herokuapp.com/admin/forgot/${token}">reset password</>
        `;
