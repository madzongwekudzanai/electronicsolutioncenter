...
router.post('/', async (req, res) => {
	...
	try {
		...
		jwt.sign(payload, jwtSecret, { expiresIn: 360000 }, (err, token) => {
          ...
          <a href="https://electronicsolutioncenter.herokuapp.com/auth/${token}">verify email</>
        `;
...
router.post('/admin', async (req, res) => {
	...
	try {
		...
		jwt.sign(payload, jwtSecret, { expiresIn: 360000 }, (err, token) => {
          ...
          <a href="https://electronicsolutioncenter.herokuapp.com/admin/${token}">verify email</>
        `;
